...
const resultArr = [
  ...
  },
  {
    ...
    content:
      "인공위성 유형은 가드닝에 자신 있지만 바쁜 일상과 집에서 생활하는 시간이 많지 않은 유형입니다.  </br> 이러한 인공위성 유형을 위해 물주는 기간이 넉넉한 식물을 추천해드립니다.  </br> 아래의 추천식물을 확인해보세요",
    svg: "satellite",
    color: "#8fd623",
    type: ["long", "hard"],
  ...
  },
  {
    ...
    content:
      "지구 유형은 죽은 식물도 살려내는 가드닝에 타고난 능력자 유형입니다. </br> 어느 식물을 키워도 잘 키워내는 당신 </br> 원하는 목적에 맞게 식물을 골라보는건 어떨까요? </br> 아래의 추천식물을 확인해보세요",
    svg: "earth",
    color: "#9abde8",
    type: ["short", "hard"],
    recomend: [
